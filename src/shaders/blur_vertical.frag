// blur_vertical.frag - Vertical Gaussian blur for bloom/post-processing
// Claude Generated - Phase 5B: Bloom post-processing (vertical blur)
#version 430 core
...
void main()
{
    ...
    for (int i = 1; i < 4; ++i) {
        ...
        vec2 coord1 = texCoord + vec2(0.0, offset * texelSize.y);
        vec2 coord2 = texCoord - vec2(0.0, offset * texelSize.y);
